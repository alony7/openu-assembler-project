...
void process_single_file(char* base_filename){
    ...
    CHECK_AND_UPDATE_SUCCESS(is_success,first_step_process(data_image, code_image, label_symbol_table, relocations_symbol_table,  am_filename, &ic, &dc, &should_second_step));
