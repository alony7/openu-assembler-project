...
static Bool rewrite_operand_word(AddressingType operand_type, int *ic, Word *code_image, SymbolTable *labels_table, SymbolTable *relocations_table, OperandRow *row,int parameter_index){
...
Bool second_step_process(Word data_image[MEMORY_SIZE], Word code_image[MEMORY_SIZE], SymbolTable *labels_table,
